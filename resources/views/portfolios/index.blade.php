                        ...
                        <tbody>
                            @foreach($portfolios as $portfolio)
                                <tr class="border-b border-border/50 hover:bg-muted/50 transition-colors">
                                    ...
                                    <td class="py-3 px-4">
                                        @if($portfolio->image)
                                            <img src="{{ str_starts_with($portfolio->image, 'http') ? $portfolio->image : asset('storage/' . $portfolio->image) }}" class="w-12 h-12 object-cover rounded-md border border-border">
                                        @else
                                    ...
                                    <td class="py-3 px-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button
                                                type="button"
                                                @click="showDeleteModal = true; deleteUrl = '{{ route('portfolios.destroy', $portfolio->id) }}'; itemTitle = '{{ e($portfolio->title) }}'"
        ...
        >
            ...
            >
                ...
                <p class="text-sm text-zinc-300 leading-relaxed">
                    Apakah Anda yakin ingin menghapus data portofolio ini? Tindakan ini <span class="text-rose-400 font-medium">tidak dapat dibatalkan</span>.
                </p>
