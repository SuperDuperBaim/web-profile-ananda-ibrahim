...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-foreground text-sm font-medium leading-5 text-foreground focus:outline-none focus:border-foreground transition duration-150 ease-in-out'
